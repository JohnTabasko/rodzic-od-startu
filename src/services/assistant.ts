...
export interface Answer { text: string; source: string; isSafety?: boolean; }
...
interface Faq { keywords: string[]; q: string; a: string; source: string; }
...
const FAQ: Faq[] = [
  ...
  {
    keywords: ['ruchy dziecka', 'kopnięcia', 'kopniecia', 'ile ruchów', 'ile ruchow', 'licznik ruchów'],
  ...
  {
    keywords: ['jeść', 'jesc', 'dieta', 'czego nie wolno', 'sushi', 'ser pleśniowy', 'ser plesniowy', 'ryby', 'kawa', 'alkohol'],
  ...
  {
    keywords: ['baby blues', 'depresja', 'smutno', 'przygnęb', 'przygneb', 'płaczę', 'placze', 'nie radzę sobie', 'nie radze sobie', 'lęk', 'lek', 'stres'],
  ...
  {
    keywords: ['karmienie', 'karmić', 'karmic', 'pierś', 'piers', 'laktacja', 'mleko', 'butelka', 'mieszanka'],
  ...
  {
    keywords: ['sen niemowlęcia', 'sen noworodka', 'nie śpi', 'nie spi', 'wybudza', 'jak spać', 'bezpieczny sen'],
...
export const ASSISTANT_DISCLAIMER = 'Jestem asystentem informacyjnym opartym o treści redakcyjne. Nie zastępuję lekarza ani położnej.';
